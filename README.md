...
Core modeling functions expect input time series to be supplied as R `ts`
objects. The `ts` class is base R's standard format for regularly spaced time
series (see the `stats::ts` documentation:
