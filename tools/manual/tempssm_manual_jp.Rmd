...
温度時系列への適用を踏まえ、`tempssm` では、この解釈しやすい分解を保ちつつ、
...
`tempssm` オブジェクトに保存され、`logLik()` や `summary()` などの下流メソッドでも
一貫して用いられます。
...
Baba et al. (2024) で用いられた黒潮関連変数に基づいて生成された
